...
// 2 2 6
// 3 4 7
// задать массив, найти наименьший эллемент в массиве, удалить строку и столбец этого элемента, 
...
void CreateArray(int[,] array){// метод заполнения массива случайными числами 
...
int[,] FindPositionSmallElement(int[,] array, int[,] position)// Метод нахождения наименьшего значения
{
  int temp = array[0, 0];
  for (int i = 0; i < array.GetLength(0); i++)
  {
